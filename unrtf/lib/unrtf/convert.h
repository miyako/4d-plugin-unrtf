...
extern void word_print(Word *w, std::string& output, OutputPersonality *op);

void print_banner(std::string& output, OutputPersonality *op);
void word_dump_date(Word *w, std::string& output);
void process_font_table(Word *w, std::string& output);
static int cmd_fonttbl(Word *w, int align, char has_param, int param, std::string& output);
